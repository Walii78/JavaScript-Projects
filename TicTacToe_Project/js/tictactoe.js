...
let activePlayer='X';
// This array stores an array of moves. We use this to determine win conditins.
let selectedSquares = [];

//This functin is for placing an x or o in a square.

function placeXOrO(squareNumber){
    //This condition ensures a square hasnt been selected already.
    //The .som() method is used to check each element of the selectSquare array
...
//squarNumber and activePlayer are concatenated together and added to array.
...
return true;
    ...
    //This function results in a random squar being selected by the computer.
...
//9 squares are selected the conde executes.
...
function arrayIncludes(squareA, squareB, squareC){
    ...
    //true is returned and our else if conditiuon executes the drawLine() function.
...
function audio(audioURL){
    ...
    let audio = new Audio(audioURL);4
    //play method plays our audio sound.
    audio.play();
}

//This functin utilizes HTML canvas to draw win lines.
function drawWinLine(coordX1, coordY1, coordX2, coordY2){
    //This line accesses our HTML canvas element.
    const canvas = document.getElementById('win-lines');
    //This line gives us access to the methods and properties to use on canvas.
    ...
    y = y1;
    //This functin interacts with the canvas.
    function animateLineDrawing(){
        ...
        //This condition is similar to the one avove.
        //This is necessary for the 6,4,2 win condition.
             ...
             //This line callls our main animation loop.
             animateLineDrawing();
             //This line waits 1 second. Then clears canvas, resets game, and allows clickin again.
             setTimeout(function(){clear(); resetGame();}, 1000);
        }

        //This funcetion resets the game in the event of a tie or a win.
        function resetGame(){
